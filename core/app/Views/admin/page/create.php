                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label>Title</label>
                                                                <input type="text" name="title" class="form-control" value="<?= isset($page) ? $page->title : '' ?>">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label>Content</label>
                                                                <textarea name="content" class="form-control" id="summernote"><?= isset($page) ? $page->content : '' ?></textarea>
                                                                <p><small class="text-danger"><?= isset($errors['content']) ? $errors['content'] : '' ?></small></p>
                                                            </div>
                                                        </div>
