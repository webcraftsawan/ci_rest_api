                                                ...
                                                <form action="<?= $form_action ?>" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="status" class="form-control">
                                                                            ...
                                                                            <option value="1" <?= set_value('status' , isset($resp->is_active) ? $resp->is_active : '') == 1 ? 'selected' : '' ?>>Active</option>
                                                                            <option value="0" <?= set_value('status' , isset($resp->is_active) ? $resp->is_active : '') == 0 ? 'selected' : '' ?>>Inactive</option>
                                                                        </select>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>From</label>
                                                                <input type="text" class="form-control datetimepicker" name="from" value="<?= set_value('from' , isset($resp->from) ? $resp->from : '') ?>">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>To</label>
                                                                <input type="text" class="form-control datetimepicker" name="to" value="<?= set_value('to',isset($resp->to) ? $resp->to : '') ?>">
