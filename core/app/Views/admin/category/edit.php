                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Title</label>
                                                                <input type="text" name="title" class="form-control" value="<?= $resp->title ?>">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="parent_id">
                                                                    ...
                                                                    <?php foreach($all_cats as $category): ?>
                                                                        <option value="<?= $category->id ?>" <?= ($resp->parent_id && $resp->parent_id == 1) ? 'selected' : '' ?>><?= $category->title ?></option>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                                <p><small class="text-danger"><?= isset($errors['parent_id']) ? $errors['parent_id'] : '' ?></small></p>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="status" class="form-control">
                                                                            ...
                                                                            <option value="1" <?= ($resp->status && $resp->status == 1) ? 'selected' : '' ?>>Active</option>
                                                                            <option value="0" <?= ($resp->status && $resp->status == 0) ? 'selected' : '' ?>>Inactive</option>
                                                                        </select>
