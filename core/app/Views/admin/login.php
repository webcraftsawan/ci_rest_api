	...
	<div class="login-box">
	  	...
	  	<?php if(isset($errors['username']) && isset($errors['password'])): ?>
		  	<div class="alert alert-danger">
			  	<p><small class="text-danger"><?= isset($errors['username']) ? $errors['username'] : '' ?></small></p>
		      	<p><small class="text-danger"><?= isset($errors['password']) ? $errors['password'] : '' ?></small></p>
		  	</div>
      	<?php endif; ?>
	  	...
	  	<form action="<?= $form_action ?>" method="post">
		    ...
		    <div class="user-box"><a href="<?= base_url('admin/forgot-password') ?>">forgot password ?</a></div>
		    <button type="submit"><span></span><span></span><span></span><span></span>Submit</button>
	  	</form>
	</div>
</body>
