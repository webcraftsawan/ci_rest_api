...
class Career extends BaseController
{
	...
	public function index(){
		...
		$data['description'] = '';
		$data['keywords'] = '';
		$data['form_action'] = base_url('admin/career/store');
		$data['user'] = $this->session->get('admin');
		$data['careers'] = $this->common_model->get('career_form');
	...
	public function view($id){
		...
		$data['description'] = '';
		$data['keywords'] = '';
		$data['form_action'] = base_url('admin/career/update/'.$id);
		$data['user'] = $this->session->get('admin');
		$data['resp'] = $this->common_model->get('career_form' , ['id' => $id]);
